...
std::vector<int64_t> BatchDecodeWithPagedKVCachePlan(
    bool use_logits_soft_cap, int64_t head_dim, at::Tensor empty_q_data, at::Tensor empty_kv_data,
...
void BatchDecodeWithPagedKVCacheRun(
    ...
    int64_t kv_layout_code, int64_t window_left, double logits_soft_cap, double sm_scale,
    double rope_scale, double rope_theta, std::optional<at::Tensor> maybe_lse, int64_t cuda_stream);
...
void single_prefill_with_kv_cache(int64_t mask_mode_code, at::Tensor q, at::Tensor k, at::Tensor v,
                                  std::optional<at::Tensor> maybe_packed_custom_mask,
                                  at::Tensor tmp, std::optional<at::Tensor> maybe_alibi_slopes,
                                  at::Tensor o, int64_t layout, int64_t window_left,
                                  double logits_soft_cap, double sm_scale, double rope_scale,
